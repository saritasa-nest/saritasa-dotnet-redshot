...
namespace RedShot.Platforms.Windows.ChildProcessTracking
{
    /// <summary>
    ...
    public static class ChildProcessTracker
    {
        ...
        /// </summary>
        /// <param name="process">Child process.</param>
        ...
        static ChildProcessTracker()
        {
            ...
            var jobName = "ChildProcessTracker-" + Guid.NewGuid();
            jobHandle = CreateJobObject(IntPtr.Zero, jobName);

            var info = default(JOBOBJECT_BASIC_LIMIT_INFORMATION);
            ...
            var extendedInfo = default(JOBOBJECT_EXTENDED_LIMIT_INFORMATION);

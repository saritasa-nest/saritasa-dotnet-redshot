...
{
    /// <summary>
    /// Represents INotifyIcon implementation for Windows OS.
    /// </summary>
...
#pragma warning restore 67
        ...
        private WindowsTrayIcon lti;
        private WindowsTrayIcon ltiProp { get => lti; set { lti = value; } }
        ...
        private void UpdateMenu()
        {
            ...
            //{
                ...
                Dispatcher.UIThread.Post(() =>
                {
                    ...
                    {
                        new Eto.Forms.Application(Eto.Platform.Detect).Run(ltiProp = new WindowsTrayIcon(this.ToolTipText, this.IconPath, this.ContextMenu));
                    }

                , canTok.Token, TaskCreationOptions.AttachedToParent, TaskScheduler.Current);
